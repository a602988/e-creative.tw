...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
        ...
        //GD字型
		$this->gd_font_file  = dirname(__FILE__). '/fonts/gd/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 42;
        ...
        $this->text_color       = new Securimage_Color('#3d3d3d');
		$this->use_multi_text   = false;
		$this->multi_text_color = array(
            new Securimage_Color('#e11931'),
    		new Securimage_Color('#ec9509'),
    		new Securimage_color('#01a315'),
    		new Securimage_Color('#3268e7')
        );
        ...
        //干擾線
		$this->num_lines = 10;
		$this->line_color = new Securimage_Color('#3d3d3d');
		$this->draw_lines_over_text = false;
        
        //簽名
		$this->image_signature = '';
		$this->signature_color = new Securimage_Color('#3d3d3d');
		$this->signature_font  = dirname(__FILE__). '/fonts/AHGBold.ttf';
        
        //發音
		$this->audio_path   = dirname(__FILE__) . '/audios/';
		...
		//sqlite
		$this->sqlite_database = dirname(__FILE__). '/database/securimage.sqlite';
