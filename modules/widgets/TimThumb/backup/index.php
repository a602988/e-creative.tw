...
class timthumb {
    ...
    public function __construct(){
        ...
        if (class_exists('Sewii\Filesystem\File')) {
            $this->src = Sewii\Filesystem\Path::toLocal($this->src);
        }
        ...
        //youtube 支援
        if (preg_match('/youtube\.com/', $this->src)) {
            ...
            if(ALLOW_ALL_EXTERNAL_SITES){
                ...
                if (!$allowed) {
                    if (!empty($_SERVER['HTTP_REFERER'])) {
                        ...
                        $safeHost = preg_replace('/^www\./i', '', $_SERVER["HTTP_HOST"]);
                        if (preg_match('/' . preg_quote($safeHost) . '/i', $refererHost)) {
                            $allowed = true;
                        }
                    }
                }
    ...
    protected function serveErrors(){
        ...
        //echo '<h1>An error has occured</h1>The following error(s) occured:<br />' . $html;
        //echo '<br />Query String : ' . htmlentities ($_SERVER['QUERY_STRING']);
